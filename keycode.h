...
extern const PROGMEM uint8_t keymaps[16][MATRIX_ROWS][MATRIX_COLS];

#define M(layer)     (0xB0 | layer)    //0xB0 ... 0xBF use for keyboard layer changing
#define _QWERTY  0
#define _WORKMAN 1
#define _COLEMAK 2
#define _DVORAK  3
...
enum hid_keyboard_keypad_usage {
  ...
  KC_DOWN,
  KC_UP,
  KC_NUMLOCK,   /* 0x53 Key num pad I want remove for another key code */
  KC_KP_SLASH,
  KC_KP_ASTERISK,
  KC_KP_MINUS,
  KC_KP_PLUS,
  ...
  KC_KP_9,
  KC_KP_0,
  KC_KP_DOT,    /* 0x63 Key num pad, I want remove for another key code */
